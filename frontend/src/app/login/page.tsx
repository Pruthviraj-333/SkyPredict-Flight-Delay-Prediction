    ...
    if (loading) {
        return (
            <div style={{
                ...
                fontFamily: "'DM Sans', sans-serif", gap: 10,
            }}>
        ...
        <div className="login-page">
            <div className="login-card animate-enter">
                ...
                <div className="login-logo">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--sky)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <p className="login-desc">
                    Sign in to run delay predictions and access the analytics dashboard.
                </p>
                ...
                <p className="login-footer">
                    By signing in you agree to the use of cookies for session management.
                </p>
            </div>
        </div>
    );
